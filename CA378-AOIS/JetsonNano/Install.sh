...
echo ID='$1'>>demo.sh
echo cd ${PWD}>>demo.sh
echo sudo ./bin/DemoGUI -id '$ID' -w 4032 -h 3040 -fps 20>>demo.sh
echo '#'sudo ./bin/DemoGUI -id '$ID' -w 3840 -h 2160 -fps 30>>demo.sh
echo '#'sudo ./bin/DemoGUI -id '$ID' -w 1920 -h 1080 -fps 120>>demo.sh
echo '#'sudo ./bin/DemoGUI -id '$ID' -w 640 -h 480 -fps 340>>demo.sh
mv demo.sh ./script/
