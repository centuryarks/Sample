...
static const struct reg_value imx378_setting_640x480_raw8[] = {
    ...
    {0x3F57, 0x4B},
    /* MIPI setting */
    {0x0112, 0x08},     // CSI_DT_FMT_H
    {0x0113, 0x08},     // CSI_DT_FMT_L
    {0x0114, 0x01},     // CSI_LANE_MODE
    /* Frame Horizontal Clock Count */
    {0x0342, 0x0F},     // LINE_LENGTH_PCK[15:8]
    {0x0343, 0xA0},     // LINE_LENGTH_PCK[7:0]
    /* Frame Vertical Clock Count */
    {0x0340, 0x03},     // FRM_LENGTH_LINES[15:8]
    {0x0341, 0x6A},     // FRM_LENGTH_LINES[7:0]
    /* Visible Size */
    {0x0344, 0x03},     // X_ADD_STA[12:8]
    {0x0345, 0xAC},     // X_ADD_STA[7:0]
    {0x0346, 0x02},     // Y_ADD_STA[12:8]
    {0x0347, 0xC0},     // Y_ADD_STA[7:0]
    {0x0348, 0x0C},     // X_ADD_END[12:8]
    {0x0349, 0x2B},     // X_ADD_END[7:0]
    {0x034A, 0x09},     // Y_ADD_END[12:8]
    {0x034B, 0x1F},     // Y_ADD_END[7:0]
    /* Mode Setting */
    ...
    {0x040B, 0x02},     // DIG_CROP_Y_OFFSET[7:0]
    {0x040C, 0x04},     // DIG_CROP_IMAGE_WIDTH[12:8]
    {0x040D, 0x3A},     // DIG_CROP_IMAGE_WIDTH[7:0]
    {0x040E, 0x03},     // DIG_CROP_IMAGE_HEIGHT[12:8]
    {0x040F, 0x2C},     // DIG_CROP_IMAGE_HEIGHT[7:0]
    /* Output Crop */
    ...
    {0x3F57, 0x56},     // LINE_LENGTH_INCK[7:0]
