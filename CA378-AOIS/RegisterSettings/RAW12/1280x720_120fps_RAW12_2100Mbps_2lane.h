...
static const struct reg_value imx378_setting_1280x720_raw12[] = {
    ...
    {0x0341, 0x64},     // FRM_LENGTH_LINES[7:0]
    /* Visible Size */
    {0x0344, 0x02},     // X_ADD_STA[12:8]
    {0x0345, 0xE8},     // X_ADD_STA[7:0]
    {0x0346, 0x03},     // Y_ADD_STA[12:8]
    {0x0347, 0x20},     // Y_ADD_STA[7:0]
    {0x0348, 0x0C},     // X_ADD_END[12:8]
    {0x0349, 0xEF},     // X_ADD_END[7:0]
    {0x034A, 0x08},     // Y_ADD_END[12:8]
    {0x034B, 0xBF},     // Y_ADD_END[7:0]
    /* Mode Setting */
    ...
    {0x040C, 0x0A},     // DIG_CROP_IMAGE_WIDTH[12:8]
    {0x040D, 0x02},     // DIG_CROP_IMAGE_WIDTH[7:0]
    {0x040E, 0x02},     // DIG_CROP_IMAGE_HEIGHT[12:8]
    {0x040F, 0xD0},     // DIG_CROP_IMAGE_HEIGHT[7:0]
    /* Output Crop */
    {0x034C, 0x05},     // X_OUT_SIZE[12:8]
    {0x034D, 0x00},     // X_OUT_SIZE[7:0]
    {0x034E, 0x02},     // Y_OUT_SIZE[12:8]
    ...
    {0x0820, 0x10},     // REQ_LINK_BIT_RATE_MBPS[31:24]
    {0x0821, 0x68},     // REQ_LINK_BIT_RATE_MBPS[23:16]
    ...
    {0x3F57, 0x86},     // LINE_LENGTH_INCK[7:0]
