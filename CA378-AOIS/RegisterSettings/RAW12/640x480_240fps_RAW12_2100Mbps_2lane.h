...
static const struct reg_value imx378_setting_640x480_raw12[] = {
    ...
    {0x0340, 0x02},     // FRM_LENGTH_LINES[15:8]
    {0x0341, 0x32},     // FRM_LENGTH_LINES[7:0]
    /* Visible Size */
    {0x0344, 0x05},     // X_ADD_STA[12:8]
    {0x0345, 0x68},     // X_ADD_STA[7:0]
    {0x0346, 0x04},     // Y_ADD_STA[12:8]
    {0x0347, 0x10},     // Y_ADD_STA[7:0]
    {0x0348, 0x0A},     // X_ADD_END[12:8]
    {0x0349, 0x6F},     // X_ADD_END[7:0]
    {0x034A, 0x07},     // Y_ADD_END[12:8]
    {0x034B, 0xCF},     // Y_ADD_END[7:0]
    /* Mode Setting */
    ...
    {0x040C, 0x05},     // DIG_CROP_IMAGE_WIDTH[12:8]
    {0x040D, 0x02},     // DIG_CROP_IMAGE_WIDTH[7:0]
    {0x040E, 0x01},     // DIG_CROP_IMAGE_HEIGHT[12:8]
    {0x040F, 0xE0},     // DIG_CROP_IMAGE_HEIGHT[7:0]
    /* Output Crop */
    {0x034C, 0x02},     // X_OUT_SIZE[12:8]
    {0x034D, 0x80},     // X_OUT_SIZE[7:0]
    {0x034E, 0x01},     // Y_OUT_SIZE[12:8]
