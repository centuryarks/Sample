...
static const struct reg_value imx378_setting_3840x2160_raw12[] = {
    ...
    {0x0343, 0x4C},     // LINE_LENGTH_PCK[7:0]
    /* Frame Vertical Clock Count */
    {0x0340, 0x0A},     // FRM_LENGTH_LINES[15:8]
    {0x0341, 0x19},     // FRM_LENGTH_LINES[7:0]
    /* Visible Size */
    ...
    {0x0409, 0x6C},     // DIG_CROP_X_OFFSET[7:0]
    {0x040A, 0x00},     // DIG_CROP_Y_OFFSET[12:8]
    {0x040B, 0x40},     // DIG_CROP_Y_OFFSET[7:0]
    ...
    {0x3F57, 0xE9},     // LINE_LENGTH_INCK[7:0]
