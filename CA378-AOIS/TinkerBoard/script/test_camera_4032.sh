...
export DISPLAY=:0.0 
media-ctl --set-v4l2 '"imx378 2-001a":0[fmt:SBGGR10_1X10/4032x3040]'
...
gst-launch-1.0 rkcamsrc device=/dev/video1 io-mode=4 isp-mode=2A tuning-xml-path=./script/IMX378_1130_XGA_LSC.xml ! videoconvert ! video/x-raw,format=NV12,width=1280,height=960  ! rkximagesink
